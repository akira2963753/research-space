...
\begin{table}[t]
    ...
    \begin{tabular}{lc}
        ...
        W/A-BiE4 & 5.974 \\
        W-BFP4 / A-BiE4 & 6.013 \\
        W-BFP4 / T2A-BiE4 & 6.016 \\
        \bottomrule
    \end{tabular}
\end{table}

\subsection{DEWA Threshold Sweep}
Perplexity remains near the Top-2 baseline (6.016) across a wide range of asymmetric DEWA thresholds under W-BFP4 / T2A-BiE4, indicating that aggressive FP-Acc bypassing is compatible with negligible accuracy loss.
