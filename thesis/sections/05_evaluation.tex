...
\begin{figure}[h]
    ...
    \caption{Normalized PE area and energy of a BFP4 baseline, a Bucket Getter PE, and the proposed PE (TSMC 90\,nm, 125\,MHz). Both metrics are normalized to the baseline.}
    \label{fig:pe_area_energy}
\end{figure}

The proposed PE is smaller than both the baseline and Bucket Getter.
Its energy is well below the baseline.
