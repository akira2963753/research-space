...
Each element stores only a sign and a low-bit mantissa, while the exponent overhead is amortized across the block.
...
In synthesized low-bit BFP-PE configurations, the FP-Acc accounts for up to 75\% of PE power and 55\% of its area (Fig.~\ref{fig:bfp_pe_ppa}), making it a primary obstacle to improving the energy and area efficiency of BFP accelerators~\cite{bucketgetter2023,winacc2025,smartblock2025}.

\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{figures/fig_bfp_pe_ppa.pdf}
    \caption{Component-level power and area breakdown of a synthesized baseline BFP-PE, showing FP-Acc dominance.}
...
This loss becomes more severe as the mantissa width decreases.
