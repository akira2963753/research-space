...
The remainder of this paper reviews BFP deployment challenges (Section~\ref{sec:background}), presents DEWA and Top-2 activation routing (Section~\ref{sec:design}), describes the BFP-PE architecture (Section~\ref{sec:architecture}), reports experimental results (Section~\ref{sec:evaluation}), and concludes (Section~\ref{sec:conclusion}).
