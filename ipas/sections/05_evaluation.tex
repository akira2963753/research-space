...
\begin{figure}[h]
    ...
    \caption{Normalized PE area and energy of a BFP4 baseline, a Bucket Getter PE, and the proposed PE (TSMC 90\,nm, 125\,MHz). Left: area. Right: energy. Bars are stacked by component and both metrics are normalized to the baseline.}
